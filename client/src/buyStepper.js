...
function getStepContent(step) {
  ...
  case 1:
      return <div><h5>It is of utmost importance to not interact with a contract sent to you by a seller, as fraudsters may adjust the LinkPal contracts to allow the withdrawal of ETH in escrow after the PayPal invoice has been paid. </h5><BuyerInteraction/></div> 
    case 2:
